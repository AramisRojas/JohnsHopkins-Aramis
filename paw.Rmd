...
Now this is the code used to fit a model. The algorith used has been Random Forest, due to the unclear structure of the data, and because these kind of models are suggested for its usage with human data modelling, due to its complexity.
